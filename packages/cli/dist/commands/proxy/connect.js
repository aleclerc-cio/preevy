...
import { jwkThumbprint, commands, profileStore, withSpinner, machineId, validateEnvId, normalizeEnvId } from '@preevy/core';
...
class Connect extends ProfileCommand {
...
Connect.description = 'Tunnel existing local compose application';
Connect.flags = {
    ...tunnelServerFlags,
    ...urlFlags,
    ...tableFlags,

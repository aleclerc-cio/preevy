import { link, localFs, profileStore, TokenExpiredError, getLivecycleTokensFromLocalFs } from '@preevy/core';
import { Flags, ux } from '@oclif/core';
import * as inquirer from '@inquirer/prompts';
import ProfileCommand from '../../profile-command.js';
import { LC_API_URL } from '../../defaults.js';
// eslint-disable-next-line no-use-before-define
class Link extends ProfileCommand {
    async run() {
...
Link.description = "Link the profile to the logged in user's organization";
export default Link;

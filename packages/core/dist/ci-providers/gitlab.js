...
export const gitlabActionsCiProvider = () => ({
    name: 'GitLab',
    id: 'gitlab',
    ...
    pullRequestNumber: () => stringOrUndefinedToNumber(process.env.CI_MERGE_REQUEST_IID || process.env.CI_EXTERNAL_PULL_REQUEST_IID),
